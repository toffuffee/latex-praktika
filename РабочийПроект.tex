...
Тесты для модуля MailMessageController приведены на рисунке \ref{templ:test1}.
...
\newpage
Тесты для модуля MailMessageController приведены на рисунке \ref{templ:test2}.
...
\newpage
Тесты для модуля ContactManager приведены на рисунке \ref{templ:test3}.
...
\newpage
Тесты для модуля TaskScheduler приведены на рисунке \ref{templ:test4}.
...
\newpage
Тесты для модуля VideoConferenceManager приведены на рисунке \ref{templ:test5}.
...
\newpage
Тесты для модуля FileStorageController приведены на рисунке \ref{templ:test6}.
